...
func (in *ClusterParameters) DeepCopyInto(out *ClusterParameters) {
	*out = *in
	...
	if in.ClusterGroupIDRef != nil {
		in, out := &in.ClusterGroupIDRef, &out.ClusterGroupIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ClusterGroupIDSelector != nil {
		in, out := &in.ClusterGroupIDSelector, &out.ClusterGroupIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ClusterTypeID != nil {
	...
	if in.ClusterTypeIDRef != nil {
		in, out := &in.ClusterTypeIDRef, &out.ClusterTypeIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ClusterTypeIDSelector != nil {
		in, out := &in.ClusterTypeIDSelector, &out.ClusterTypeIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.SiteID != nil {
